...
public class MyService extends Service {
    ...
    public static String emergencyHospitalID = "";
                            ...
                            if(e==null){
                                if(objects.size()>0){
                                    ...
                                    for(ParseObject object:objects){
                                        String id = object.getString("hospitalName");
                                        String emergency = object.getString("status");
                                        if(ParseUser.getCurrentUser()!=null){
                                            if(id.equals(String.valueOf(ParseUser.getCurrentUser().getUsername())) && emergency.equals("TRUE")){
